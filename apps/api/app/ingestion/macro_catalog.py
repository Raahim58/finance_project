...
MACRO_SERIES = (
    ...
    MacroSeriesSpec(
        ...
        "fx",
        (
            _sbp("sbp.usd_pkr.m2m", 10),
            _sbp_unverified("USD_PKR", 11),
            _imf("PAK", "ENDA"),
            _wb("PAK", "PA.NUS.FCRF"),
        ),
    ),
    ...
    MacroSeriesSpec(
        "PK_RESERVES_USD",
        "Pakistan total foreign-exchange reserves",
        "USD",
        "weekly",
        "external",
        (
            _sbp("sbp.total_reserves_usd", 10),
            _sbp_unverified("TOTAL_RESERVES_USD", 11),
