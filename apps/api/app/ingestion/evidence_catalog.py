...
SOURCE_SPECS = (
    ...
    SourceSpec("imf_news", "International Monetary Fund", "https://www.imf.org", "official", ("primary",), ("pakistan_macro", "global_macro"), "listing", 600, 1825, discovery_url="https://www.imf.org/en/news", topic="global_macro", link_pattern=r"^https://www\.imf\.org/en/news/(?:articles|press-releases|speech)/"),
    SourceSpec("gdelt", "GDELT DOC 2", "https://api.gdeltproject.org", "discovery", ("discovery",), ("global",), "gdelt", 900, 90, discovery_url="https://api.gdeltproject.org/api/v2/doc/doc", topic="pakistan_macro"),
    ...
    SourceSpec("nccpl_notices", "National Clearing Company of Pakistan", "https://www.nccpl.com.pk", "official", ("primary",), ("pakistan_markets", "clearing_regulation"), "listing", 3600, 365, settings.evidence_pass4_official_enabled, "https://www.nccpl.com.pk/legal-framework", "pakistan_markets", r"^https://(?:www\.)?nccpl\.com\.pk/(?:storage|legal-framework).+", "pass4_official", 30, 12, 5, 75 * 1024 * 1024, "manual CSV/import remains available for inaccessible datasets"),
